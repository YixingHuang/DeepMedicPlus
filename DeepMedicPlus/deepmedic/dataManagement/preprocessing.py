...
def pad_imgs_of_case(channels, prior_channels, gt_lbl_img, roi_mask, wmaps_to_sample_per_cat,
    ...
    if not pad_input_imgs:
        ...
        return channels, prior_channels, gt_lbl_img, roi_mask, wmaps_to_sample_per_cat, pad_left_right_axis
    ...
    prior_channels = pad_4d_arr(prior_channels, pad_left_right_per_axis)
