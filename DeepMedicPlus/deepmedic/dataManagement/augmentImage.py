...
def augment_imgs_of_case(channels, prior_channels, gt_lbls, roi_mask, wmaps_per_cat, prms):
    ...
    if prms is not None:
        ...
        wmaps_per_cat) = random_affine_deformation( channels,
                                                    ...
                                                    wmaps_per_cat,
                                                    prms['affine'] )
    return channels, prior_channels, gt_lbls, roi_mask, wmaps_per_cat


def random_affine_deformation(channels, prior_channels, gt_lbls, roi_mask, wmaps_l, prms):
    if prms is None:
    ...
    prior_channels = augm(images_l= prior_channels,
                    transf_mtx=transf_mtx,
                    interp_orders=prms['interp_order_imgs'],
                    boundary_modes=prms['boundary_mode'])
    ...
    return channels, prior_channels, gt_lbls, roi_mask, wmaps_l
