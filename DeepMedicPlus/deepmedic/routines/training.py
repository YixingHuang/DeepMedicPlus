...
def process_in_batches(log,
    ...
    for batch_i in range(n_batches):
        ...
        if train_or_val == "train":
            ...
            feeds_dict.update({feeds['x_prior']: channs_samples_per_path[1][min_idx_batch: max_idx_batch]})
            for subs_path_i in range(cnn3d.numSubsPaths):
                x_batch_sub_path = channs_samples_per_path[subs_path_i + 2][min_idx_batch: max_idx_batch]
...
def do_training(sessionTf,
                ...
                paths_per_prior_chan_per_subj_train,
                paths_per_prior_chan_per_subj_val,
